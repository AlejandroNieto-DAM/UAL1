...
public class TestBaraja {
	...
	public void setUp() throws Exception {
		...
		/*
		for(int i = 0; i < cartasNP.length; i++) {
			//System.out.print(cartasNP[i].getPalo() + cartasNP[i].getValor() + " ");
		}*/
	...
	public void testEqualsCarta() {
		...
		assertEquals(false, carta3.equals(8));
	...
	public void testOrdenarBarajaInsercion() {
		...
		/**
		System.out.println("Debug barajar");
		for (int i = 0; i < cartas.length - 1; i++) {
			//System.out.println(cartas[i]+" <-> "+ cartas[i + 1]);
			System.out.print(cartas[i].getPalo() + cartas[i].getValor() + " ");
		}*/
		...
		/* 
		System.out.println("Debug despues de ordenar");
