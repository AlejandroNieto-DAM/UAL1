...
public class Fraccion implements Comparable {
	...
	public int compareTo(Object obj) {
		...
		if(obj instanceof Fraccion) {
			Fraccion fr = (Fraccion) obj;
			
			double numero1 = (Double.valueOf(this.getNumerador()) / Double.valueOf(this.getDenominador()));
			double numero2 = (Double.valueOf(fr.getNumerador()) / Double.valueOf(fr.getDenominador()));
